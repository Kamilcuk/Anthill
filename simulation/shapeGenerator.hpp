...
public:
	...
	/// Returns a set of points which form a line from start to end of specified thickness
	std::set<Point> GenerateLine(const Point& start, const Point& end, int thickness);
